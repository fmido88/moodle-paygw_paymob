...
$string['card_deleted'] = 'The selected card has been successfuly deleted.';
...
$string['gatewaydescription'] = 'Paymob is an authorised payment gateway provider for processing online transactions.';
...
$string['kiosk_process_help_en'] = 'To pay, Please go to the nearest Aman or Masary outlet, ask for "مدفوعات اكسبت/ Madfouaat Accept" and provide your reference number.';
...
$string['payment_attention'] = 'Attension required about you last payment {$a}';
...
$string['payment_receipt_url'] = 'Click here for the reciept';
$string['paymentcancelled'] = 'The payment is declined or cancelled. </br> reason: {$a}';
$string['paymentmethods'] = 'Payment Methods';
$string['paymentsuccessful'] = 'Your payment is successful';
$string['pluginname'] = 'Paymob payment';
$string['pluginname_desc'] = 'Using Accept payment (by paymob) to recive transactions from moodle website';
